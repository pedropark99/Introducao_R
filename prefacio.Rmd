...
Lattes: \url{http://lattes.cnpq.br/0308632529554550}

Site pessoal: \url{https://pedro-faria.netlify.app/}
...
\textbf{João Pedro Figueira Amorim Parga}
...
Lattes: \url{http://lattes.cnpq.br/8639351648030747}
...
\section*{O que é esse livro?}
\addcontentsline{toc}{section}{O que é esse livro?}
...
\section*{Novidades desta terceira edição}
\addcontentsline{toc}{section}{Novidades desta terceira edição}
...
Sexto, o apêndice contendo as respostas dos exercícios foi retirado, com o objetivo de reduzir o número de páginas do livro. Consequentemente, as respostas dos exercícios estão sendo disponibilizadas em um PDF separado, o qual pode ser baixado gratuitamente, a partir da página de publicação do livro^[\url{https://pedro-faria.netlify.app/pt/publication/book/introducao_linguagem_r/}].



\section*{Porque aprender R? Quais são as suas vantagens?}
\addcontentsline{toc}{section}{Porque aprender R? Quais são as suas vantagens?}
...
\subsection*{Computadores e linguagens de programação}
...
\subsection*{Velocidade e capacidade de processamento}
...
\subsection*{Reproducibilidade: automatizando processos e reduzindo riscos}
