...
knitr::include_graphics("./../Figuras/environments.pdf")
```
...
knitr::include_graphics("./../Figuras/environments2.pdf")
```
...
#| label: fig-parent1
knitr::include_graphics("./../Figuras/parent1.pdf")
```
...
#| label: fig-parent2
knitr::include_graphics("./../Figuras/parent2.pdf")
```
...
knitr::include_graphics("./../Figuras/search_path.pdf")
```
...
knitr::include_graphics("./../Figuras/exemplo_path1.pdf")
```
