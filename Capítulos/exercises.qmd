...
```{r, echo = FALSE}
knitr::include_graphics("./../Figuras/salmao_bar.pdf")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./../Figuras/plot_exec_cap9.pdf")
```
...
if (is_latex_output()) {
  knitr::include_graphics("./../Figuras/exec_parte1.pdf")
}
```
...
if (is_latex_output()) {
  knitr::include_graphics("./../Figuras/exec_parte2.pdf")
}
```
