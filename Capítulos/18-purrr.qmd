...
knitr::include_graphics("./../Figuras/map_simple.pdf")
```
...
#| label: fig-map
knitr::include_graphics("./../Figuras/map.pdf")
```
...
#| label: fig-dif-map
knitr::include_graphics("./../Figuras/dif_map.pdf")
```
...
#| label: fig-nest
knitr::include_graphics("./../Figuras/nest.pdf")
```
...
knitr::include_graphics("./../Figuras/map_dfr.pdf")
```
...
knitr::include_graphics("./../Figuras/map_dfc.pdf")
```
...
knitr::include_graphics("./../Figuras/map2.pdf")
```
...
knitr::include_graphics("./../Figuras/map2_simple.pdf")
```
...
knitr::include_graphics("./../Figuras/pmap_simple.pdf")
```
...
#| label: fig-reduce
knitr::include_graphics("./../Figuras/reduce.pdf")
```
...
knitr::include_graphics("./../Figuras/accumulate.pdf")
```
