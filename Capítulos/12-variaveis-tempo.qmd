...
#| out.width: "60%"
#| fig.cap: "Códigos que representam cada componente de uma data"
knitr::include_graphics("./../Figuras/tab-date-format-codes.png")
```
...
```{r}
as_datetime("2020-01-01 10:40:35 Paris")
...
```{r}
as_datetime("2020-01-01 10:40:35", tz = "Europe/Paris")
...
```{r}
as_datetime("2020-01-01 10:34:12", tz = "Asia/Qatar")
as_datetime("2020-01-01 10:34:12", tz = "America/New_York")
