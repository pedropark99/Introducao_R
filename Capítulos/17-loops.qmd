...
```{r}
#| echo: false
#| fig.cap: "Como a soma entre dois vetores é executada em diferentes linguagens de programação" 
#| label: fig-vetorizacao
knitr::include_graphics("./../Figuras/vetorizacao.pdf")
```
...
Code that takes a ‘whole object’ view is likely to be both clearer and faster in R [@Rintroduction, pp. 41].
