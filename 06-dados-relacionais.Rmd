...
```{r, echo = F, fig.cap = "Cruzamento entre as tabelas de acordo com a coluna name", out.width="100%"}
...
```{r, echo = F, fig.cap = "Resumo das relações possíveis entre keys, inspirado em  Wickham e Grolemund (2017)", out.width="100%"}
