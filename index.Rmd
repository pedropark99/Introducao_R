...
Através deste site, você pode ler o livro completo gratuitamente. Você também pode [comprar uma versão física ou em Ebook deste livro na Amazon](https://pedro-faria.netlify.app/publications/book/introducao_linguagem_r/pt/#sec-versoes). Atualmente, o livro se encontra em sua 4° edição, e está licenciado segundo a Licença Creative Commons - Atribuição - NãoComercial 4.0 Internacional. Você pode visitar a [página dessa licença](http://creativecommons.org/licenses/by-nc/4.0/).
...
FARIA, Pedro Duarte. *Introdução à Linguagem R:* seus fundamentos e sua prática. 4. ed.
Belo Horizonte: [s.n.], 2022. ISBN 978-65-00-57872-0. Disponível em: 
<https://pedro-faria.netlify.app/pt/publication/book/introducao_linguagem_r/>.

Agora, se você preferir, temos disponível logo abaixo, todos os componentes da referência em formato BibTex:
