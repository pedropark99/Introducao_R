...
<a href="https://pedro-faria.netlify.app/pt/publication/book/introducao_linguagem_r/"><img src="capa.jpg" width="250" height="366" class="cover" /></a> Olá! Este é o site do livro "Introdução à Linguagem R: seus fundamentos e sua prática". Aqui você pode ler o conteúdo do livro de maneira eficiente e gratuita. Para mais, você também pode baixar uma versão em PDF deste livro de forma gratuita, através da [página de publicação do livro](https://pedro-faria.netlify.app/pt/publication/book/introducao_linguagem_r/).
