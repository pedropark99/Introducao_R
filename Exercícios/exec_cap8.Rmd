...
8.2.A) A bandeira do movimento LGBTQ+. Como uma ajuda, nós temos abaixo um vetor contendo os códigos de cada cor presente nessa bandeira:
...
8.2.B) Considerando a função quadrática $y = x^2 + 15x + 32$, desenhe a curva da função para o intervalo de 0 < $x$ < 1000.
